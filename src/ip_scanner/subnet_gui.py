...
class SubnetCalculatorPage(QWidget):
    ...
    def _build_ui(self):
        ...
        panel_style = (
            "QFrame#calculatorPanel { background: white; border: 1px solid #e4e7ed; "
            "border-radius: 10px; }"
        )
        input_frame.setStyleSheet(panel_style)
        ...
        input_layout.addWidget(QLabel("基础网络"), 0, 0)
        input_layout.addWidget(self.base_network, 0, 1, 1, 5)
        input_layout.addWidget(QLabel("划分方式"), 1, 0)
        input_layout.addWidget(self.mode, 1, 1)
        input_layout.addWidget(self.parameter_pages, 1, 2, 1, 2)
        input_layout.addWidget(self.calculate_button, 1, 4)
        input_layout.addWidget(self.reset_button, 1, 5)
        root.addWidget(input_frame)

        self.summary_frame = QFrame()
        self.summary_frame.setObjectName("calculatorPanel")
        self.summary_frame.setStyleSheet(panel_style)
        ...
        self.reset_window_button.setObjectName("secondary")
